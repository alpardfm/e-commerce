...
type Location struct {
	...
	Lat       string    `json:"lat" db:"lat,omitempty" param:"lat"`
	Long      string    `json:"long" db:"long,omitempty" param:"long"`
	Distance  int64     `json:"distance" db:"distance,omitempty" param:"distance"`
	Secret    string    `json:"secret" db:"secret,omitempty" param:"secret"`
