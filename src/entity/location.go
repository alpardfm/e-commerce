...
type Location struct {
	...
	Lat       string    `db:"lat" json:"lat,omitempty" param:"lat"`
	Long      string    `db:"long" json:"long,omitempty" param:"long"`
	Distance  int64     `db:"distance" json:"distance,omitempty" param:"distance"`
	Secret    string    `db:"secret" json:"secret,omitempty" param:"secret"`
...
type PaginationLocation struct {
