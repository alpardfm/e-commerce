...
type Payments struct {
	...
	PaymentMethod string    `json:"payment_method" db:"payment_method,omitempty" param:"payment_method"`
	PaymentStatus string    `json:"payment_status" db:"payment_status,omitempty" param:"payment_status"`
	TransactionID string    `json:"transaction_id" db:"transaction_id,omitempty" param:"transaction_id"`
